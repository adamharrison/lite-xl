...
# Main executable
FLAGS="$FLAGS $@ -Ilibs/freetype/include -Ilibs/lua -Ilibs/pcre2/src -Isrc -O3 -fno-strict-aliasing -DPCRE2_STATIC -L. -lm  -llite -static-libgcc `$SDL_CONFIG --cflags` `$SDL_CONFIG --libs`"
